...
use Carbon\Carbon;
use App\Services\YouTube\Exceptions\InvalidXmlException;
use App\Services\YouTube\Exceptions\LoadFeedUrlException;
...
class RssFeed
{
     ...
     *
     * @return Channel
     * @throws Exceptions\LoadFeedUrlException
     */
     ...
     *
     * @return Channel
     * @throws Exceptions\InvalidXmlException
     */
